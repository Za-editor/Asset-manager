...
ALTER TABLE "purchase" ADD CONSTRAINT "purchase_asst_id_asset_id_fk" FOREIGN KEY ("asst_id") REFERENCES "public"."asset"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
